...
#ifndef MIDIPRODUCERMENU_H
#define MIDIPRODUCERMENU_H

#include <Menu.h>
#include <Messenger.h>


class MidiProducerMenu : public BMenu
{
public:
	MidiProducerMenu(const char* name, int32  id, const BMessenger& target
		, BMessage* message);
};
#endif