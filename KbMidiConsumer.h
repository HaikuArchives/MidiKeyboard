...
#ifndef KBVIEWMIDICONSUMER_H
#define KBVIEWMIDICONSUMER_H

#include <MidiConsumer.h>
#include "midi_engine.h"

class KbMidiConsumer : public BMidiLocalConsumer
{
public:
	KbMidiConsumer(const char* name);
	virtual	void NoteOff(uchar channel, uchar note
		, uchar velocity, bigtime_t time);
	virtual	void NoteOn(uchar channel, uchar note
		, uchar velocity, bigtime_t time);
	virtual void Data(uchar *data, size_t length
