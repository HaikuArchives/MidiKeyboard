...
#ifndef MIDICONSUMERMENU_H
#define MIDICONSUMERMENU_H

#include <Menu.h>
#include <Messenger.h>


class MidiConsumerMenu : public BMenu
{
public:
	MidiConsumerMenu(const char* name, int32 id, const BMessenger& target
		, BMessage* message);
};
